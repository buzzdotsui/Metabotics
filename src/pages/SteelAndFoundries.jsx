...
export default function SteelAndFoundries() {
  ...
  return (
    <>
      <section className="page-hero" id="steel-hero" style={{ paddingBottom: '0', position: 'relative', overflow: 'hidden', minHeight: '400px', display: 'flex', alignItems: 'center' }}>
        <div className="article-hero-bg" style={{ backgroundImage: `url(https://images.unsplash.com/photo-1504938096384-e9102377c0bd?q=80&w=2070&auto=format&fit=crop)` }}></div>
